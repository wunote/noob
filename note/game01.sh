...
jieshao=(0 "+10体力     " "+15体力     " "+20法力     " "1/10几率逃脱" "随机1次     " "随机10次    ")
money=(0 8 12 16 60 13 140) #商品价格
tao=0 #获得的逃脱卡牌
day=1 #天数
shu=(0 0 0 0 0) #十连抽
...
echo -e "\033["33"m\033[6;55H 法师：因为你是一个低级法师，每天可以+10法力从而召唤卡牌\033[0m"
...
e=`echo $[a+b+c]`
let tao+=d
xiaoxi 获得张$a治愈，$b张恢复，$c张圣光，$d张逃脱
xiaoxi 恢复$e体力，逃脱卡牌增加$d张
}
